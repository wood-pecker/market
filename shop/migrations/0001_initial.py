# Generated by Django 4.2.9 on 2024-01-17 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_delivery_date', models.DateTimeField(verbose_name='Желаемое время доставки')),
                ('actual_delivery_date', models.DateTimeField(verbose_name='Фактическое время доставки')),
                ('products', models.ManyToManyField(related_name='products', to='shop.product')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order', to='shop.category')),
